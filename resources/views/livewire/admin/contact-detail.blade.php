<div>
    ...
    <div class="container mx-auto p-4">
        <div class="shadow-md p-6">
            <h2 class="text-2xl font-bold mb-4 ">Contact Detail</h2>
            <div class="grid grid-cols-1 gap-4">
                @if($contact)
                    <div class="flex flex-col">
                        <label class="font-semibold mb-2">Name</label>
                        <div class="flex items-center border border-gray-300 p-2">
                            <span class="w-full font-medium ">{{ $contact->nama }}</span>
                        </div>
                    </div>
                    <div class="flex flex-col">
                        <label class="font-semibold mb-2">Phone</label>
                        <div class="flex items-center border border-gray-300 p-2">
                            <span class="w-full font-medium ">{{ $contact->nomor }}</span>
                        </div>
                    </div>
